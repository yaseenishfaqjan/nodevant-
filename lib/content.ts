...
export const CASE_STUDIES: CaseStudy[] = [
  {
    ...
    title: "An all-in-one financial hub with end-to-end client automation",
    challenge:
      "A fintech business needed a single platform to unify credit intelligence, credit- and debit-card insights, funding, real-estate opportunities, client communications, and billing — work that doesn't scale by hand.",
    solution:
      "We built a complete financial hub on Next.js + FastAPI + Supabase: a branded client portal, automated 3-bureau credit monitoring, card and spending insights, AI-matched funding, real-estate opportunity discovery, AI document generation, and Stripe subscription billing. White-label ready.",
    metrics: [
      { value: "All-in-one", label: "Financial hub platform" },
...
export const SOLUTIONS: Solution[] = [
  {
    ...
    title: "Financial Hub Platform",
    metaTitle: "Fintech AI Automation System | Nodevant",
    tag: "Storehouse360",
    intro:
      "Financial businesses run on accuracy and turnaround. This is a complete financial hub — onboarding, client portal, credit intelligence and monitoring, credit- and debit-card insights, AI-matched funding, real-estate opportunities, communications, and billing — in one white-label platform, so your team handles exceptions instead of paperwork and clients watch everything in real time.",
    workflow: [
      "Client signs up and is onboarded through a branded portal",
      "The system pulls 3-bureau credit data and surfaces every actionable insight automatically",
      "AI compiles card, funding and real-estate opportunities plus document workflows, ready for review",
      "Documents are generated, delivered and tracked through to completion",
      "Client dashboards update in real time, and billing runs on Stripe",
    ],
    short:
      "A complete white-label financial hub — client portal, 3-bureau credit monitoring, card & funding insights, real-estate opportunities, AI document generation, and subscription billing in one platform.",
    problem:
      "Financial operations drown in manual workflows, scattered bureau and account data, document generation, and client updates — work that scales linearly with headcount and is riddled with errors that cost clients results.",
    included: [
      "Branded client portal with onboarding and real-time progress",
      "Automated 3-bureau credit monitoring with status tracking",
      "Credit- and debit-card spending insights in one view",
      "AI-matched funding and real-estate opportunity discovery",
